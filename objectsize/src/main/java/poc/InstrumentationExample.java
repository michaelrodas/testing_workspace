...
import poc.dao.StoreProviderImpl;
...
public class InstrumentationExample {
    ...
    public static void main(String[] arguments) {
        ...
        JsonStore mappedObject = StoreProviderImpl.getFileMappedToObject();
        printObjectSize(mappedObject);
        printObjectSize(mappedObject.getStores());
        printObjectSize(mappedObject.getStores().get(0));
    }
